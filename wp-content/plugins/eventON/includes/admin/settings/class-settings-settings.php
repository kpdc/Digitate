...
class evo_settings_settings{
		...
		return apply_filters('eventon_settings_tab1_arr_content', array(
			array(
				...
				'fields'=> apply_filters('eventon_settings_general', array(
					...
					array('id'=>'evo_hide_shortcode_btn','type'=>'yesno','name'=>__('Hide add eventon shortcode generator button from wp-admin','eventon'), 'legend'=>__('This will remove the [] ADD EVENTON button that appear above text editor next to media button. This button allow you to open shortcode generator to create eventon shortcodes easily.')),
					...
					array('id'=>'evcal_additional','type'=>'note','name'=>sprintf(__('Looking for additional functionality including event tickets, frontend event submissions, RSVP to events, photo gallery and more? <br/><a href="%s" style="margin-top:5px;"target="_blank" class="evo_admin_btn btn_triad">Check out eventON addons</a>' ,'eventon'), 'http://www.myeventon.com/addons/')),
			))),
			array(
				'id'=>'evcal_005',
	...
	// Search
		function content_search(){
			ob_start();?>
			<p>By default search icon and search bar are set to visible in all calendars, once you activate EventON Search.<br/>You can <strong>disable search</strong> by adding the before variable into shortcodes:
			<br/><br/><code>search="no"</code> example within a shortcode <code>[add_eventon search="no"]</code>
