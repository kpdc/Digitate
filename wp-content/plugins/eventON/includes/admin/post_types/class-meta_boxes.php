		...
		function event_edit_tax_section($tax, $eventid){
			...
			?>
				...
				<p class='evo_selected_tax_actions'>
					<a class='evo_tax_term_list evo_btn ajde_popup_trig' data-type='list' data-popc='evo_term_lightbox' data-eventid='<?php echo $eventid;?>' data-id='<?php echo $event_tax_term[0]->term_id;?>'>Select different <?php echo $tax_name;?> from list</a>
					<a class='evo_tax_term_form evo_btn ajde_popup_trig' data-popc='evo_term_lightbox' data-type='new' ><?php _e('Create a new','eventon'); echo ' '.$tax_name;?></a>
				</p>
				...
				?>
				<p class='evo_selected_tax_actions'>
					<a class='evo_tax_term_list evo_btn ajde_popup_trig' data-type='list' data-popc='evo_term_lightbox' data-eventid='<?php echo $eventid;?>'>Select a <?php echo $tax_name;?> from list</a>
					<a class='evo_tax_term_form evo_btn ajde_popup_trig' data-popc='evo_term_lightbox' data-eventid='<?php echo $eventid;?>' data-type='new' data-tax='event_location'><?php _e('Create a new','eventon'); echo ' '.$tax_name;?></a>
				</p>
				<?php
			}
			return ob_get_clean();
